<?php
  ...
  if (isset($_POST['submit']))
  {
      ...
      // checks if it is a valid and university email address
      if (!preg_match('/^[a-z0-9_\-]+(\.[_a-z0-9\-]+)*@([_a-z0-9\-]+\.)+edu$/i', $_POST['email']))
      {
          die('You must have a valid and .edu email address to register for an account.');
      }
